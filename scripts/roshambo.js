...
let userName = 'William "Roshambo" Wallace';
const computerName = 'ROSHAM-BOT 3K';
let boutCount = 1;
let matchCount = 1;
let compEngagementWin = false;   // used for advanced AI logic
let killSwitch = false;          // extra condition for exiting program
